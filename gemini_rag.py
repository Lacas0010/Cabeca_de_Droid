...
class GeminiRAG:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if is_rate_limit and attempt < max_retries - 1:
                    print(f"🔹 [INFO] Limite de requisições atingido. Aguardando 12s para tentar novamente ({attempt + 1}/{max_retries})...")
                    time.sleep(12)
                else:
                    raise e
    ...
    def test_connection(self) -> tuple[bool, str]:
        ...
        try:
            ...
            # Resolve o melhor modelo candidato usando a chave informada
