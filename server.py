...
from extractor import MultiGameExtractor, clean_relic_name, sanitize_stat_name, clean_genshin_url
    ...
    if data:
        ...
        for char in data:
            ...
            if game_id == "zzz":
                ...
                if char.get("icon"):
                    char["icon"] = clean_genshin_url(char["icon"])
                if char.get("gacha_art"):
                    char["gacha_art"] = clean_genshin_url(char["gacha_art"])
